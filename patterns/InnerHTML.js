...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget"], function (require, exports, __extends, __decorate, decorators_1, Widget, widget_1) {
    ...
    var InnerHTML = /** @class */ (function (_super) {
        ...
        //
        //--------------------------------------------------------------------------
        InnerHTML.prototype.render = function () {
            var someExternalContent = "<b>I am bold!</b>";
            return (widget_1.tsx("div", { class: CSS.base, innerHTML: someExternalContent }));
        };
        InnerHTML = __decorate([
            decorators_1.subclass("examples.InnerHTML")
        ], InnerHTML);
        return InnerHTML;
