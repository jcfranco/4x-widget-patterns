...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget"], function (require, exports, __extends, __decorate, decorators_1, Widget, widget_1) {
    ...
    var HandlingMultipleEvents = /** @class */ (function (_super) {
        __extends(HandlingMultipleEvents, _super);
        function HandlingMultipleEvents() {
            //--------------------------------------------------------------------------
            //
            //  Variables
            //
        ...
        //
        //--------------------------------------------------------------------------
        HandlingMultipleEvents.prototype.render = function () {
        ...
        //
        //--------------------------------------------------------------------------
        HandlingMultipleEvents.prototype._itemToStyles = function (id) {
            // using inline-styles for demo purposes only
            return {
                "font-weight": this._focusedItem === id ? "bolder" : ""
            };
        };
        HandlingMultipleEvents.prototype._handleFocus = function (event) {
            var node = event.currentTarget;
            this._focusedItem = node.getAttribute("data-item-id");
        };
        HandlingMultipleEvents.prototype._handleBlur = function (event) {
            var node = event.currentTarget;
            if (this._focusedItem === node.getAttribute("data-item-id")) {
                this._focusedItem = null;
            }
        };
        HandlingMultipleEvents = __decorate([
            decorators_1.subclass("examples.HandlingMultipleEvents")
        ], HandlingMultipleEvents);
        return HandlingMultipleEvents;
