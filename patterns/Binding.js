    ...
    var Binding = /** @class */ (function (_super) {
        ...
        Binding.prototype.render = function () {
            return (widget_1.tsx("div", { class: CSS.base },
                widget_1.tsx("div", { bind: this, onclick: this._handlerWhereThisIsWidget }, "this === widget"),
                widget_1.tsx("div", { onclick: this._handlerWithThisIsNode }, "this === node")));
        };
        //--------------------------------------------------------------------------
        //
        //  Private Methods
        //
        //--------------------------------------------------------------------------
        Binding.prototype._handlerWhereThisIsWidget = function () {
            console.log(this); // this === widget instance
        };
        Binding.prototype._handlerWithThisIsNode = function () {
            console.log(this); // this === DOM node
        };
        Binding = __decorate([
            decorators_1.subclass("examples.Binding")
        ], Binding);
        return Binding;
